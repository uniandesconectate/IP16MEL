		...
		<section>
			<div class="container">
				<h1>Opciones</h1>
					...
					<g:link controller="request" action="notasEstudiantes">Editar notas de los estudiantes</g:link><br />
					<g:link controller="request" action="comprarEquipo">Comprar poderes</g:link><br />
